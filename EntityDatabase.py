...
class entityDatabase():
    ...
    def associateEntity(self,entity,k=None):
        """Associates entity in database to entitys that appear in a similar context.
           Params:entity(str/tuple(str))- target entity. Can either be a string with incorrect capitalizeation(assumes full
                  string is one entity) or an entity(a tuple of strings) with correct capitalization.
